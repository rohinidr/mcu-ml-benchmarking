 ...
 */
#define MODEL_INPUT_SIZE        490     /* 49 frames × 10 MFCC coefficients */
#define MODEL_NUM_CLASSES       35      /* Google Speech Commands v2 */

/* Update these from: python model/convert.py --model model/dscnn_int8.tflite --print-quant-params */
